      ...
      <div className="flex flex-wrap">
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            <h1 className="pb-12 text-6xl font-bold tracking-tight lg:mt-12 text-gray-700">Stuti Goyal</h1>
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center lg:justify-start lg:ml-15"> {/* Slightly shift image right */}
            <img src={ProfilePic} alt="Stuti" className="w-41 rounded-lg shadow-lg" /> {/* Bigger size */}
          </div>
        </div>
      </div>
    </div>
